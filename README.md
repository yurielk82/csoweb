...
```bash
npm test              # 전체 유닛+통합+컴포넌트 (108개 케이스)
...
| Application Use Case | 6 | 30 | `application/user/*`, `application/settlement/*`, `application/cso-matching/*` |
| API 통합 | 3 | 21 | `api/auth/login`, `api/auth/register`, `api/settlements` |
